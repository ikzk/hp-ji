...
var G__10180 = o;
(G__10180[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10184 = o;
(G__10184[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__10186__i < G__10186__a.length) {G__10186__a[G__10186__i] = arguments[G__10186__i + 0]; ++G__10186__i;}
  args = new cljs.core.IndexedSeq(G__10186__a,0,null);
} 
...
var args = cljs.core.seq(arglist__10187);
...
var G__10189 = props;
var G__10189__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10189,cljs.core.cst$kw$id,id):G__10189);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10189__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10190){
var map__10191 = p__10190;
var map__10191__$1 = ((((!((map__10191 == null)))?(((((map__10191.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10191.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10191):map__10191);
var props = map__10191__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10191__$1,cljs.core.cst$kw$class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10193){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10194__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10194,map__10194__$1,on_write){
return (function (){
...
});})(node_value,map__10194,map__10194__$1,on_write))
);
} else {
...
var G__10197 = jsprops;
(G__10197["defaultValue"] = value);

(G__10197["onChange"] = ((function (G__10197,v,value,on_change){
return (function (p1__10196_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10196_SHARP_);
});})(G__10197,v,value,on_change))
);
...
var vec__10200 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10200,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10200,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10200,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10204 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10204 == null)){
} else {
var key_10205 = temp__5461__auto___10204;
(jsprops["key"] = key_10205);
}
...
var temp__5461__auto___10206 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10206 == null)){
} else {
var key_10207 = temp__5461__auto___10206;
reagent.impl.template.oset(jsprops,"key",key_10207);
}
...
var G__10208 = reagent.impl.template.__GT_NativeWrapper();
(G__10208["name"] = c);
...
var G__10209 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10209) : reagent.impl.template.as_element.call(null,G__10209));
} else {
...
var len__4499__auto___10214 = arguments.length;
var i__4500__auto___10215 = (0);
while(true){
if((i__4500__auto___10215 < len__4499__auto___10214)){
args__4502__auto__.push((arguments[i__4500__auto___10215]));

var G__10216 = (i__4500__auto___10215 + (1));
i__4500__auto___10215 = G__10216;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10212){
var G__10213 = cljs.core.first(seq10212);
var seq10212__$1 = cljs.core.next(seq10212);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10213,seq10212__$1);
});
...
break;
default:
var G__10219 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10219;
continue;
...
var n__4376__auto___10221 = a.length;
var i_10222 = (0);
while(true){
if((i_10222 < n__4376__auto___10221)){
(a[i_10222] = reagent.impl.template.as_element((a[i_10222])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___10224 = a.length;
var i_10225 = (0);
while(true){
if((i_10225 < n__4376__auto___10224)){
var val_10226 = (a[i_10225]);
if(((cljs.core.vector_QMARK_(val_10226)) && ((reagent.impl.template.key_from_vec(val_10226) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10225] = reagent.impl.template.as_element(val_10226));

var G__10227 = (i_10225 + (1));
i_10225 = G__10227;
continue;
} else {
}
...
var ctx = ({});
var vec__10228 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10228,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10228,(1),null);
...
var G__10231 = (cljs.core.count(argv) - first_child);
switch (G__10231) {
case (0):
...
case (1):
var G__10232 = comp;
var G__10233 = jsprops;
var G__10234 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10232,G__10233,G__10234) : reagent.impl.template.global$module$react.createElement.call(null,G__10232,G__10233,G__10234));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10231){
