...
if((i < len)){
var k = (ks[i]);
var G__10115 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10116 = (i + (1));
m = G__10115;
i = G__10116;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10117 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10117) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10117));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10119 = c;
var G__10119__$1 = (((G__10119 == null))?null:G__10119.prototype);
if((G__10119__$1 == null)){
return null;
} else {
return (G__10119__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10121 = c;
var G__10121__$1 = (((G__10121 == null))?null:G__10121.prototype);
if((G__10121__$1 == null)){
return null;
} else {
return (G__10121__$1["render"]);
}
})() == null))));
});
...
var G__10123 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10123) : reagent.impl.component.as_element.call(null,G__10123));
};
...
var _STAR_current_component_STAR_10129 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10129;
}});
...
var G__10130 = key;
var G__10130__$1 = (((G__10130 instanceof cljs.core.Keyword))?G__10130.fqn:null);
switch (G__10130__$1) {
...
return ((function (G__10130,G__10130__$1){
...
var c = this;
var G__10131_10133 = (c["cljsRatom"]);
if((G__10131_10133 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10131_10133);
}
...
var renders_10135 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10136 = cljs.core.first(cljs.core.vals(renders_10135));
if((cljs.core.count(renders_10135) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10135))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10136)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10136], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10134 = name;
switch (G__10134) {
case "":
...
var G__10139 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10139) : reagent.impl.component.global$module$create_react_class.call(null,G__10139));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10140 = fiber;
var G__10140__$1 = (((G__10140 == null))?null:(G__10140["type"]));
if((G__10140__$1 == null)){
return null;
} else {
return (G__10140__$1["displayName"]);
}
})();
var parent = (function (){var G__10141 = fiber;
if((G__10141 == null)){
return null;
} else {
return (G__10141["return"]);
}
})();
var path = (function (){var G__10142 = parent;
var G__10142__$1 = (((G__10142 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10142) : reagent.impl.component.fiber_component_path.call(null,G__10142)));
if((G__10142__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10142__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__10144 = c;
if((G__10144 == null)){
return null;
} else {
return (G__10144["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__10145._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__10147 = c;
if((G__10147 == null)){
return null;
} else {
return (G__10147["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__10149 = c;
if((G__10149 == null)){
return null;
} else {
return G__10149._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__10151 = instance;
if((G__10151 == null)){
return null;
} else {
return (G__10151["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__10152 = instance;
if((G__10152 == null)){
return null;
} else {
return G__10152._currentElement;
}
}
})();
var name = (function (){var G__10153 = elem;
var G__10153__$1 = (((G__10153 == null))?null:(G__10153["type"]));
if((G__10153__$1 == null)){
return null;
} else {
return (G__10153__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__10155 = elem;
if((G__10155 == null)){
return null;
} else {
return (G__10155["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__10156._owner;
}
}
})();
var path = (function (){var G__10157 = owner;
var G__10157__$1 = (((G__10157 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10157) : reagent.impl.component.component_path.call(null,G__10157)));
if((G__10157__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10157__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10158 = c;
var G__10158__$1 = (((G__10158 == null))?null:G__10158.constructor);
if((G__10158__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10158__$1);
}
}
})();
