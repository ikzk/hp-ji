...
if((i < len)){
var k = (ks[i]);
var G__10119 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10120 = (i + (1));
m = G__10119;
i = G__10120;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10121 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10121) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10121));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10123 = c;
var G__10123__$1 = (((G__10123 == null))?null:G__10123.prototype);
if((G__10123__$1 == null)){
return null;
} else {
return (G__10123__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10125 = c;
var G__10125__$1 = (((G__10125 == null))?null:G__10125.prototype);
if((G__10125__$1 == null)){
return null;
} else {
return (G__10125__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__10129__delegate = function (args){
var G__10127 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10127) : reagent.impl.component.as_element.call(null,G__10127));
};
...
while (G__10130__i < G__10130__a.length) {G__10130__a[G__10130__i] = arguments[G__10130__i + 0]; ++G__10130__i;}
  args = new cljs.core.IndexedSeq(G__10130__a,0,null);
} 
return G__10129__delegate.call(this,args);};
...
return G__10129__delegate(args);
});
...
var _STAR_current_component_STAR_10133 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10133;
}});
...
var G__10134 = key;
var G__10134__$1 = (((G__10134 instanceof cljs.core.Keyword))?G__10134.fqn:null);
switch (G__10134__$1) {
...
return ((function (G__10134,G__10134__$1){
...
var c = this;
var G__10135_10137 = (c["cljsRatom"]);
if((G__10135_10137 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10135_10137);
}
...
var renders_10139 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10140 = cljs.core.first(cljs.core.vals(renders_10139));
if((cljs.core.count(renders_10139) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10139))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10140)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10140], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10138 = name;
switch (G__10138) {
case "":
...
var G__10143 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10143) : reagent.impl.component.global$module$create_react_class.call(null,G__10143));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10144 = fiber;
var G__10144__$1 = (((G__10144 == null))?null:(G__10144["type"]));
if((G__10144__$1 == null)){
return null;
} else {
return (G__10144__$1["displayName"]);
}
})();
var parent = (function (){var G__10145 = fiber;
if((G__10145 == null)){
return null;
} else {
return (G__10145["return"]);
}
})();
var path = (function (){var G__10146 = parent;
var G__10146__$1 = (((G__10146 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10146) : reagent.impl.component.fiber_component_path.call(null,G__10146)));
if((G__10146__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10146__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__10148 = c;
if((G__10148 == null)){
return null;
} else {
return (G__10148["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__10149._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__10151 = c;
if((G__10151 == null)){
return null;
} else {
return (G__10151["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__10153 = c;
if((G__10153 == null)){
return null;
} else {
return G__10153._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__10155 = instance;
if((G__10155 == null)){
return null;
} else {
return (G__10155["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__10156 = instance;
if((G__10156 == null)){
return null;
} else {
return G__10156._currentElement;
}
}
})();
var name = (function (){var G__10157 = elem;
var G__10157__$1 = (((G__10157 == null))?null:(G__10157["type"]));
if((G__10157__$1 == null)){
return null;
} else {
return (G__10157__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__10159 = elem;
if((G__10159 == null)){
return null;
} else {
return (G__10159["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__10160._owner;
}
}
})();
var path = (function (){var G__10161 = owner;
var G__10161__$1 = (((G__10161 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10161) : reagent.impl.component.component_path.call(null,G__10161)));
if((G__10161__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10161__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10162 = c;
var G__10162__$1 = (((G__10162 == null))?null:G__10162.constructor);
if((G__10162__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10162__$1);
}
}
})();
